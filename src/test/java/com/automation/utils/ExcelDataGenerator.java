...
public class ExcelDataGenerator {
    ...
    private static final String[][] TEST_DATA = {
        ...
        { "TC_SEARCH_002","testSearch",                 "Search 'hoodie' returns at least one product",     "firefox", "true", "At least one product returned",            "Y", "",  "","", "hoodie",                  "",          "true", "",      "",  "",  "",    ""   },
        ...
        { "TC_NAV_002",   "testPageNavigation",         "Store page title and URL are correct",             "chromium","true", "Title has Store and URL has /store/",        "Y", "",  "","", "",  "","", "",          "",   "/store/",   "Store",     "/store/"    },
        { "TC_NAV_003",   "testPageNavigation",         "Account page title and URL are correct",           "chromium","true", "Title has My Account and URL has /account/","Y", "",  "","", "",  "","", "",          "",   "/account/", "My Account","/account/"  },
